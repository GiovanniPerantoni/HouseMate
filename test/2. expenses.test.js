...
test("controllare l'api /api/v1/apartment/expenses/view funzioni", async () => {
	return request(app).get('/api/v1/apartment/expenses/view').set(commonOptions).set('x-access-token', global.validOwners[0].token).send({
		limit: 1 
	}).then((res) => {
...
test("controllare l'api /api/v1/apartment/expenses/add funzioni", async () => {
	return request(app).post('/api/v1/apartment/expenses/add').set(commonOptions).set('x-access-token', global.validOwners[0].token).send({
		product: "pizza",
...
test("controllare l'api /api/v1/apartment/expenses/modify risponda", async () => {
	return request(app).patch('/api/v1/apartment/expenses/modify').set(commonOptions).set('x-access-token', global.validOwners[0].token)
	.then((res) => {
		expect(res.status).toBeLessThan(500);
	});
});
...
test("controllare l'api /api/v1/apartment/expenses/modify funzioni", async () => {
	return request(app).patch('/api/v1/apartment/expenses/modify').set(commonOptions).set('x-access-token', global.validOwners[0].token).send({
...
test("controllare l'api /api/v1/apartment/expenses/delete risponda", async () => {
	return request(app).delete('/api/v1/apartment/expenses/delete').set(commonOptions).set('x-access-token', global.validOwners[0].token)
	.then((res) => {
		expect(res.status).toBeLessThan(500);
	});
});
...
test("controllare l'api /api/v1/apartment/expenses/delete funzioni", async () => {
	return request(app).delete('/api/v1/apartment/expenses/delete').set(commonOptions).set('x-access-token', global.validOwners[0].token).send({
